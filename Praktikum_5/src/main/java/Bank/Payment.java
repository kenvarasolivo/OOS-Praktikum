...
public class Payment extends Transaction {
    ...
    public void setIncomingInterest(double IncomingInterest) throws TransactionAttributeException {
        if (IncomingInterest >= 0 && IncomingInterest <= 1) { //Überprüft wenn es zwischen 0 und 1
            ...
            throw new TransactionAttributeException (" Not a valid Incoming Interest ");
        }
    }
    ...
    public void setOutgoingInterest(double OutgoingInterest) throws TransactionAttributeException {
        if (OutgoingInterest >= 0 && OutgoingInterest <= 1) { //Überprüft wenn es zwischen 0 und 1
            ...
            throw new TransactionAttributeException (" Not a valid Outgoing Interest ");
        }
    }
     ...
     */
    public Payment(String date, double amount, String description) throws TransactionAlreadyExistException, TransactionAttributeException {
     ...
     */
    public Payment(String date2, double amount2, String description2, double incoming, double outgoing) throws TransactionAlreadyExistException, TransactionAttributeException {
     ...
     */
    public Payment(Payment other) throws TransactionAlreadyExistException, TransactionAttributeException {
    ...
    public boolean equals(Object obj) {
        ...
        return (super.equals(obj) &&
                incomingInterest == other.getIncomingInterest() &&
                outgoingInterest == other.getOutgoingInterest());
    }
}