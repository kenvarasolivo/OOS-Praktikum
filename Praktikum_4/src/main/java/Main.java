...
public class Main {
    public static void main(String[] args) throws TransactionAlreadyExistException, AccountAlreadyExistsException, TransactionAttributeException, IOException {
//        PrivateBank Commerz = new PrivateBank("Commerz", 0.5, 0.4);
//
//        Commerz.createAccount("Ken", List.of(
//                new OutgoingTransfer("09.11.2024",520,"this is Transfer","Ken","Hanif"),
//                new Payment("10.11.2024",1200,"this is deposit",0.15,0.1),
//                new Payment("11.11.2024",-1100,"this is deposit",0.12,0.3),
//                new IncomingTransfer("12.11.2024",450,"this is Transfer","Timothy","Ken")
//        ));
//
//        Commerz.readAccounts();
