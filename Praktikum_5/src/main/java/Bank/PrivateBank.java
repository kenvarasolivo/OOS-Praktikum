...
public class PrivateBank implements Bank{
    ...
    public void deleteAccount(String account) throws AccountDoesNotExistException, IOException {
        ...
        // Entferne das Konto aus der Map
        accountsToTransactions.remove(account);

        // Lösche die entsprechende Datei
        File file = new File(directoryName, account + ".json");
        if (file.exists() && !file.delete()) {
            throw new IOException("Failed to delete account file: " + file.getAbsolutePath());
        }
        System.out.println("Account successfully deleted: " + account);
    }
